...
//         private void HandleError(dynamic error, int duration, TestData ecfeed)
//         {
...
//         private void HandleErrorType(string[] error, int duration, string type, TestData ecfeed)
//         {
//             if (error.Length > 0)
//             {
//                 ecfeed.feedback(false, comment:string.Join("\n", error), duration:duration, custom:new Dictionary<string, string>{{"Error type", type}});
//                 Assert.Fail();
//             }
//         }
...
//                 ecfeed.feedback(true, duration:GetTime(stopwatch));
//             }
//             catch (WebException e)
//             {
//                 string message = $"The connection could not be established.";
//                 ecfeed.feedback(false, comment:message);
