...
//         static private IEnumerable GenRandomQuantitySingle = ConfigDefault.GetTestProvider(stage).GenerateRandom(ConfigDefault.F_TEST, feedback:true,
//             length:1, label:"Random / Quality - Single");
//         static private IEnumerable GenRandomQuantityShort = ConfigDefault.GetTestProvider(stage).GenerateRandom(ConfigDefault.F_TEST, feedback:true, 
//             length:(int)(new Random().Next(100, 500)), label:"Random / Quantity - Short");
//         static private IEnumerable GenRandomQuantityLong = ConfigDefault.GetTestProvider(stage).GenerateRandom(ConfigDefault.F_TEST, feedback:true, 
//             length:(int)(new Random().Next(1000, 5000)), label:"Random / Quantity - Long");
//         static private IEnumerable GenRandom = ConfigDefault.GetTestProvider(stage).GenerateRandom(ConfigDefault.F_TEST, feedback:true, 
//             label:"Random");
//         static private IEnumerable GenRandomAdaptive = ConfigDefault.GetTestProvider(stage).GenerateRandom(ConfigDefault.F_TEST, feedback:true, 
//             length:10, adaptive:false, label:"Random - Adaptive");
//         static private IEnumerable GenRandomDuplicates = ConfigDefault.GetTestProvider(stage).GenerateRandom(ConfigDefault.F_TEST, feedback:true, 
//             length:10, duplicates:true, label:"Random - Duplicates");
//         static private IEnumerable GenNWise = ConfigDefault.GetTestProvider(stage).GenerateNWise(ConfigDefault.F_TEST, feedback:true, 
//             label:"NWise");
//         static private IEnumerable GenNWiseN = ConfigDefault.GetTestProvider(stage).GenerateNWise(ConfigDefault.F_TEST, feedback:true, 
//             n:3, label:"NWise - N");
//         static private IEnumerable GenNWiseCoverage = ConfigDefault.GetTestProvider(stage).GenerateNWise(ConfigDefault.F_TEST, feedback:true, 
//             coverage:50, label:"NWise - Coverage");
//         static private IEnumerable GenNWiseConstraintsNone = ConfigDefault.GetTestProvider(stage).GenerateNWise(ConfigDefault.F_TEST, feedback:true, 
//             constraints:"NONE", label:"NWise / Constraints - None");
//         static private IEnumerable GenNWiseConstraintsSelected = ConfigDefault.GetTestProvider(stage).GenerateNWise(ConfigDefault.F_TEST, feedback:true, 
//             constraints:new string[]{"constraint1", "constraint2"}, label:"NWise / Constraints - Selected");
//         static private IEnumerable GenNWiseChoicesSelected = ConfigDefault.GetTestProvider(stage).GenerateNWise(ConfigDefault.F_TEST, feedback:true, 
...
//         static private IEnumerable GenCartesian = ConfigDefault.GetTestProvider(stage).GenerateCartesian(ConfigDefault.F_TEST, feedback:true, 
//             label:"Cartesian");
//         static private IEnumerable GenStatic = ConfigDefault.GetTestProvider(stage).GenerateStatic(ConfigDefault.F_TEST, feedback:true, 
//             label:"Static");
//         static private IEnumerable GenStaticAll = ConfigDefault.GetTestProvider(stage).GenerateStatic(ConfigDefault.F_TEST, feedback:true, 
//             testSuites:"ALL", label:"Static - All");
//          static private IEnumerable GenStaticSelected = ConfigDefault.GetTestProvider(stage).GenerateStatic(ConfigDefault.F_TEST, feedback:true, 
//             testSuites:new string[]{"suite1"}, label:"Static - Selected");
//         static private IEnumerable GenNWiseFeedback = ConfigDefault.GetTestProvider(stage).GenerateNWise(ConfigDefault.F_TEST, feedback:true, 
