...
namespace exampleNUnit
{
    ...
    {
        static private IEnumerable GenRandomQuantitySingle = ConfigDefault.GetTestProvider(ConfigDefault.PROD).GenerateRandom(ConfigDefault.F_TEST, feedback:false,
            length:1, label:"Random / Quality - Single");

        static private IEnumerable GenRandomQualityStructureSingle = ConfigDefault.GetTestProvider(ConfigDefault.DEVELOP).GenerateRandom(ConfigDefault.F_STRUCTURE, feedback:false,
        ...
        // public void GenRandomQuantitySingleTest(int arg1, int arg2, int arg3)
        // {
