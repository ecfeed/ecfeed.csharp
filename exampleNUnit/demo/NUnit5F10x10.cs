...
//         static private IEnumerable GenRandomQuantitySingle = ConfigDefault.GetTestProvider(stage).GenerateRandom(ConfigDefault.F_10x10, feedback:true,
//             length:1, label:"Random / Quality - Single");
//         static private IEnumerable GenRandomQuantityShort = ConfigDefault.GetTestProvider(stage).GenerateRandom(ConfigDefault.F_10x10, feedback:true, 
//             length:(int)(new Random().Next(100, 500)), label:"Random / Quantity - Short");
//         static private IEnumerable GenRandomQuantityLong = ConfigDefault.GetTestProvider(stage).GenerateRandom(ConfigDefault.F_10x10, feedback:true, 
//             length:(int)(new Random().Next(1000, 5000)), label:"Random / Quantity - Long");
//         static private IEnumerable GenRandomCustom = ConfigDefault.GetTestProvider(stage).GenerateRandom(ConfigDefault.F_10x10, feedback:true, 
//             length:1, label:"Random / Custom", custom:new Dictionary<string, string>{{"key1", "value1"}, {"key2", "value2"}});
//         static private IEnumerable GenNWise = ConfigDefault.GetTestProvider(stage).GenerateNWise(ConfigDefault.F_10x10, feedback:true, 
//             label:"NWise");
//         static private IEnumerable GenNWiseFeedback = ConfigDefault.GetTestProvider(stage).GenerateNWise(ConfigDefault.F_10x10, feedback:true, 
